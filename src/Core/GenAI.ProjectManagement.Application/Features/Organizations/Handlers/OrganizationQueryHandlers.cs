...
using GenAI.ProjectManagement.Application.DTOs.Organization;
using GenAI.ProjectManagement.Application.DTOs.User;
using GenAI.ProjectManagement.Application.Features.Organizations.Queries;
using GenAI.ProjectManagement.Domain.Interfaces;
using MediatR;

namespace GenAI.ProjectManagement.Application.Features.Organizations.Handlers;
