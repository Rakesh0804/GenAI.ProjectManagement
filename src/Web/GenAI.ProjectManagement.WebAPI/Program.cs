...
using GenAI.ProjectManagement.Application.Extensions;
using GenAI.ProjectManagement.Infrastructure.Extensions;
using GenAI.ProjectManagement.Persistence.Extensions;
using GenAI.ProjectManagement.Persistence.Context;
using GenAI.ProjectManagement.Infrastructure.Services;
using GenAI.ProjectManagement.Persistence.Seeders;
...
if (app.Environment.IsDevelopment())
{
    try
    {
        ...
        var passwordService = scope.ServiceProvider.GetRequiredService<GenAI.ProjectManagement.Domain.Interfaces.Services.IPasswordHashingService>();
        var counterService = scope.ServiceProvider.GetRequiredService<GenAI.ProjectManagement.Domain.Interfaces.Services.ICounterService>();
